...
namespace ABAPAI.Domain.Commands.Event
{
    public class UpdateEventCommand : Notifiable, ICommand
    {
        ...
        public UpdateEventCommand(string image, string title, string description, DateTime? dateTimeStart, DateTime? dateTimeEnd, int? eventCategory, int? valueEvent, bool? publicLimit, double? price, int? quantity, bool emitQrCode, int? dDD, string phone, string name_url, string uRL, CreateAddressCommand address)
        {
            Image = image;
            Title = title;
        ...
        public void UpdateId(string id_user, string id_event)
        {
